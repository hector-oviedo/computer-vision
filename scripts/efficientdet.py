...
class EfficientDetProcessor:
    ...
    def get_class_names(self):
        ...
        return config.get('label_names', [f'class_{i}' for i in range(config.num_classes)])

    def process_frame(self, frame):
        # Scale up the input frame
        ...
        for i in filtered_indices:
            ...
            # Scale down the box coordinates to the original frame dimensions
